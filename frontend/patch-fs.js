...
// Detect if we are on Windows and NOT on a Vercel container
const isWindows = process.platform === 'win32';
const isVercel = !!(process.env.VERCEL || process.env.NOW_BUILDER);

if (isWindows && !isVercel) {
  // =============================================================================
  // AlphaTrade FS Patch — Bulletproof Mapped Drive Support (Windows Only)
  // =============================================================================
  ...
  if (process.env.NODE_ENV !== 'production') {
    console.log('[AlphaTrade FS Patch] Platform is not Windows or running in Vercel. Patching bypassed.');
  }
}
